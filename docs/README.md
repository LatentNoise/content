...
- [architecture-decisions/](architecture-decisions/) — ADR 0001–0018; the two
  most recent: [0017 artifact naming](architecture-decisions/0017-artifact-naming.md),
  [0018 delivery by default](architecture-decisions/0018-default-delivery-policy.md)
