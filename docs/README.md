...
- [architecture-decisions/](architecture-decisions/) — ADR 0001–0029. Awaiting a
  decision: [0029 a document with sections](architecture-decisions/0029-a-document-with-sections.md),
  [0027 playlist synchronization](architecture-decisions/0027-playlist-synchronization.md),
